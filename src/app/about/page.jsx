  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={ containerRef }>
        {/* TEXT CONTAINER */ }
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-60%">
          {/* BIOGRAPHY CONTAINER */ }
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */ }
            <Image
              src="https://avatars.githubusercontent.com/u/66404246?v=4"
              alt=""
              width={ 112 }
              height={ 112 }
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="pt-3 text-sm italic">
                    ⇢ Part of the engineering team and adoption of Next.js, Redux toolkit, and .Net as backend service in building
                    Plateaumed EMR application.
                  </div>
                  {/* JOB DATE */ }
                  <div className="pt-2 text-red-400 text-sm font-semibold">
                    May 2022 - Present 
                  </div>
                  {/* JOB COMPANY */ }
                  <div className="py-3 text-sm italic">
                    Plateaumed offers simplified, affordable world-class healthcare solutions through electronic medical records system, hospital management information system.
                  </div>
                  <div className="p-1 px-4 rounded bg-white text-sm font-semibold w-fit">
                    Plateaumed Limited
                  </div>
                </div>
                {/* CENTER */ }
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */ }
                  <div className="pt-3 text-sm italic">
                    I spearheaded Next.js-based application development,
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    Implement the content management system (Headless CMS of the Website using Rest API from strapi.io)
                  </div>
                  {/* JOB DATE */ }
                  ...
                  <div className="p-1 px-4 rounded bg-white text-sm font-semibold w-fit">
                    Canary Point Corporate Services 
                  </div>
                </div>
                {/* CENTER */ }
                <div className="w-1/6 flex justify-center">
        ...
        {/* SVG CONTAINER */ }
        <div className="hidden lg:block w-1/3 sticky top-0 z-30 xl:w-40%">
